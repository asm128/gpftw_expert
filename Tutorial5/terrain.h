...
#pragma pack( push, 1 )
	...
	struct SModelGND {
				...
				::llc::STexture<::STileMapping>						TileMapping;
...
//																	SModelGND			(const SModelGND& other)	= default;
	...
	enum TILE_FACE_FACING 
		...
		, TILE_FACE_FACING_LEFT
			...
			::llc::error_t										gndGenerateFaceGeometry			(const SGNDFileContents& loaded, TILE_FACE_FACING facing_direction, int32_t textureIndex, SModelNodeGND& generated, ::llc::grid_view<::STileMapping> & tileMapping);
#pragma pack(pop)
