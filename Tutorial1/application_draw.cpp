...
#include "llc_bitmap_target.h"
	...
	const ::llc::SMatrix4<float>												& projection								= applicationInstance.SceneTransforms.FinalProjection	;
	const ::llc::SMatrix4<float>												& viewMatrix								= applicationInstance.SceneTransforms.View				;
